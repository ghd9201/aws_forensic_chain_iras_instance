...
CORE_PEER_ADDRESS=p0.org2.fchain.com:7051 peer channel join -b fchannel.block
CORE_PEER_ADDRESS=p1.org2.fchain.com:7051 peer channel join -b fchannel.block

CORE_PEER_ADDREE=p0.org2.fchain.com:7051 peer channel update --channelID fchannel --file ./channel-artifacts/fchannel.anchor.org2 --orderer orderer.fchain.com:7050
