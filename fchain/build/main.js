...
var _pino = __webpack_require__(18);
...
const member = __webpack_require__(19);
...
var _swagger = __webpack_require__(16);
...
var _swaggerExpressMiddleware = __webpack_require__(17);
...
function routes(app) {
  ...
  app.use('/api/v1/fchain', _router4.default);
}
...
var _examplesDb = __webpack_require__(25);
...
var _fchain = __webpack_require__(28);

var _fchain2 = _interopRequireDefault(_fchain);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class Controller {
  getObject(req, res) {
    _fchain2.default.getObject(req, res).then(r => {
      if (r) res.json(r);else res.status(404).end();
    });
  }

  delete(req, res) {
    _fchain2.default.delete(req, res).then(r => {
      if (r) res.json(r);else res.status(404).end();
    });
  }
...
const transaction = __webpack_require__(29);
...
class FchainService {
  getObject(req, res) {
    ...
    return Promise.resolve(transaction.queryChainCode(null, 'fchannel', 'fchain', args, 'query', 'admin', 'Org1'));
  }
...
exports.default = new FchainService();
