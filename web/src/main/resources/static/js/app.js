...
(function() {
    ...
    function initSweetAlert() {
        ...
        $('#swal-signUp').on('click', function(e) {
            e.preventDefault();
            swal("Disabled", "You can just login now.", "warning")
        });
        ...
        var dropzoneOptions = {
            ...
            init: function() {
                ...
                this.on('successmultiple', function( files, response ) {
                	...
                	var resultFileArray = JSON.parse(response);
                	ajaxMyPage(resultFileArray);
                	dzHandler.removeAllFiles();
                	datatable1.ajax.reload();
                	swal("성공", "파일이 등록 되었습니다.", "success");
                });
...
(function() {
    ...
    function initDatatables() {
        ...
        datatable2 = $('#datatable2').DataTable({
			...
			ajax : {
				url: "/servlet/Monitoring_selectList",
				type: "POST",
				dataSrc: '',
			},
            responsive: true,
        ...
        datatable3 = $('#datatable3').DataTable({
            'paging': true, // Table pagination
            'ordering': true, // Column ordering
            'info': true, // Bottom left status text
			ajax : {
